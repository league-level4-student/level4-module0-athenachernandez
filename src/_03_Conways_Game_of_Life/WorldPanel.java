...
//			if (i >= 0 && i < cells.length-1 && i != row) {
//				for (int j = col - 1; j <= col + 1; j++) {
//					if (j >= 0 && j < cells.length-1 && j != col) {
...
//		}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (cells[xClicked][yClicked].isAlive) {
			cells[xClicked][yClicked].isAlive = false;
		} else {
			cells[xClicked][yClicked].isAlive = true;
		}
